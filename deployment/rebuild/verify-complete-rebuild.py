...
for path in retired_prep: require(not path.exists(), f"retired prep duplicate returned: {path.relative_to(ROOT)}")

shared_test = read(ROOT / "tests" / "shared-foundation.test.mjs")
for expected in ["../site/worker/shared/response.js","../site/worker/shared/html.js","../site/worker/shared/validation.js","../site/worker/shared/solar-sanitizers.js"]:
