...
assert.equal(CORE_ROUTE_REGISTRY.length, 41);
...
for (const required of ["system","admin-auth","analytics","leads","supplier-leads","marketplace","inventory","sok-stock","solar","compatibility"]) {
