...
export const CORE_ROUTE_REGISTRY = Object.freeze([
  ...
  { match: "prefix-or-exact", path: "/api/admin/email-operations", domain: "email-operations", handler: "handleAdminEmailOperations", access: "admin-mixed" },
  { match: "exact", path: "/api/email-workflows/order-confirmation", domain: "email-operations", handler: "handleOrderConfirmation", access: "public-write" },
  ...
  { match: "prefix-or-exact", path: "/api/admin/sok-stock", domain: "sok-stock", handler: "handleSokStockAdminApi", access: "admin-mixed" },
  ...
  { match: "prefix-or-exact", path: "/api/admin/supplier-leads", domain: "supplier-leads", handler: "handleAdminSupplierLeads", access: "admin-mixed" },
