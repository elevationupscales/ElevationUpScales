...
export const PUBLIC_ROUTES = new Map([
  ...
  ['/shop/sok', route('/shop/sok', 'SOK | Elevation UpScales', 'Explore SOK power products through Elevation UpScales.')],
  ['/shop/renogy', route('/shop/renogy', 'Renogy | Elevation UpScales', 'Explore Renogy power products through Elevation UpScales.')],
  ['/shop/vevor', route('/shop/vevor', 'VEVOR | Elevation UpScales', 'Explore VEVOR products through Elevation UpScales.')],
  ['/shop/kingboss', route('/shop/kingboss', 'Kingboss | Elevation UpScales', 'Explore Kingboss power products through Elevation UpScales.')],
...
const EXACT_REDIRECTS = new Map([
  ['/index.html', { location: '/', status: 301 }],
  ['/home-services.html', { location: '/home-services', status: 301 }],
  ['/rv-services.html', { location: '/rv-services', status: 301 }],
  ['/solar-services.html', { location: '/solar-services', status: 301 }],
  ['/privacy.html', { location: '/privacy', status: 301 }],
  ['/terms.html', { location: '/terms', status: 301 }],
  ['/store.html', { location: '/store', status: 301 }],
  ['/collector.html', { location: '/collector', status: 301 }],
  ['/start-a-project.html', { location: '/start-a-project', status: 301 }],
  ['/other-ways-we-can-help.html', { location: '/other-ways-we-can-help', status: 301 }],
  ['/work-with-us.html', { location: '/work-with-us', status: 301 }],
  ['/product.html', { location: '/product', status: 301 }],
  ['/lithium-batteries', { location: '/store?department=lithium-batteries', status: 301 }],
  ['/lithium-batteries/', { location: '/store?department=lithium-batteries', status: 301 }],
  ['/lithium-batteries.html', { location: '/store?department=lithium-batteries', status: 301 }],
  ['/rv-store', { location: '/store?department=rv-outdoor', status: 301 }],
  ['/rv-store/', { location: '/store?department=rv-outdoor', status: 301 }],
  ['/rv-store.html', { location: '/store?department=rv-outdoor', status: 301 }],
  ['/kingboss-batteries', { location: '/shop/kingboss', status: 301 }],
  ['/kingboss-batteries/', { location: '/shop/kingboss', status: 301 }],
  ['/kingboss-batteries.html', { location: '/shop/kingboss', status: 301 }],
  ['/marketplace', { location: '/store', status: 301 }],
  ['/marketplace/', { location: '/store', status: 301 }],
  ['/marketplace.html', { location: '/store', status: 301 }],
  ['/make-a-listing', { location: '/store', status: 301 }],
  ['/make-a-listing/', { location: '/store', status: 301 }],
  ['/make-a-listing.html', { location: '/store', status: 301 }],
  ['/report-an-issue', { location: '/other-ways-we-can-help', status: 301 }],
  ['/report-an-issue/', { location: '/other-ways-we-can-help', status: 301 }],
  ['/report-an-issue.html', { location: '/other-ways-we-can-help', status: 301 }],
  ['/vehicles', { location: '/store', status: 301 }],
  ['/vehicles/', { location: '/store', status: 301 }],
  ['/vehicles.html', { location: '/store', status: 301 }],
  ['/rv', { location: '/store?department=rv-outdoor', status: 301 }],
  ['/rv/', { location: '/store?department=rv-outdoor', status: 301 }],
  ['/rv.html', { location: '/store?department=rv-outdoor', status: 301 }],
  ['/rvs', { location: '/store?department=rv-outdoor', status: 301 }],
  ['/rvs/', { location: '/store?department=rv-outdoor', status: 301 }],
  ['/rvs.html', { location: '/store?department=rv-outdoor', status: 301 }],
  ['/outdoor-store', { location: '/store?department=rv-outdoor', status: 301 }],
  ['/rv-outdoor-store', { location: '/store?department=rv-outdoor', status: 301 }],
  ['/shop/rv', { location: '/store?department=rv-outdoor', status: 301 }],
  ['/gallery', { location: '/', status: 301 }],
  ['/gallery/', { location: '/', status: 301 }],
  ['/gallery.html', { location: '/', status: 301 }],
  ['/product/', { location: '/product', status: 308 }],
  ['/start-a-project/', { location: '/start-a-project', status: 308 }],
  ['/other-ways-we-can-help/', { location: '/other-ways-we-can-help', status: 308 }],
  ['/work-with-us/', { location: '/work-with-us', status: 308 }],
  ['/solar-project/', { location: '/solar-project', status: 308 }]
]);
...
const RETIRED_STORE_ALIASES = new Set([
  '/list-a-vehicle', '/list-a-vehicle/', '/list-a-vehicle.html',
  '/list-a-motorcycle', '/list-a-motorcycle/', '/list-a-motorcycle.html',
  '/list-a-boat', '/list-a-boat/', '/list-a-boat.html',
  '/list-a-bicycle', '/list-a-bicycle/', '/list-a-bicycle.html',
  '/list-used-gear', '/list-used-gear/', '/list-used-gear.html',
  '/sell', '/sell-a-vehicle', '/sell-a-car', '/sell-a-truck', '/list-a-car', '/list-a-truck',
...
export function resolveCompatibilityRedirect(url) {
  ...
  if (projectType) {
    return { location: `/start-a-project?type=${projectType}&source=legacy-route`, status: 302 };
  }

  if (RETIRED_STORE_ALIASES.has(url.pathname)) return { location: '/store', status: 301 };
  if (url.pathname === '/sell-an-rv' || url.pathname === '/list-an-rv' || url.pathname === '/list-an-rv/' || url.pathname === '/list-an-rv.html') {
    return { location: '/store?department=rv-outdoor', status: 301 };
  }

  return null;
}

export function canonicalUrl(routeInfo) {
  return `${CANONICAL_ORIGIN}${routeInfo?.path || '/'}`;
}
