...
|---|---|---|---|---|---|---|
| MPM / Operating System Project Manager (PM4) | Operating System | Casey | Master Management | ACTIVE | `PROFITABILITY_RECOVERY_WORKFLOW_V1_0.md` + direct-site revenue P0 + eBay P0 parallel recovery + vendor/project routing + Workboard reconciliation; no-paid-ads owner lock active; seller-verification appeal terminal/waiting; TikTok Affiliate profitability separate | 2026-09-12 |
...
| Company Operations Manager / COM 2 | Company Operations | MPM | Operations / Commercial Consolidation | ACTIVE | `COMPANY_OPS_COMMERCIAL_SWEEP_WORKTREE_2026-09-12.md` — consolidates current owning-lane truth; VEVOR 3 released + shoe-dryer economics-hold exception; Renogy 2 ACTIVE / 4 DRAFT; no paid ads; does not create competing vendor/channel truth or replay completed current-window work | 2026-09-12 |
| MASTER RECON OS | Operating System | MPM | OS Integrity / RECON | ACTIVE | Current OS sweep / source-version alignment / control-surface propagation / COM 2 drift prevention / duplicate and terminal-worktree replay prevention | 2026-09-12 |
