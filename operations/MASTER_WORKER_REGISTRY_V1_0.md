...
|---|---|---|---|---|---|---|
| MPM / Operating System Project Manager | Operating System | Casey | Master Management | ACTIVE | `CURRENT_WORK_BOARD.md` + `MPM5_STREAMLINED_EXECUTION_MODE_2026-09-12.md`; foreground P0 = communications recovery + Shopify existing-shop/payment readiness + eBay customer/cash recovery; DEV trigger-only | 2026-09-12 |
...
| Peter Torres — Ecommerce & Vendor Operations Manager | Company Operations / Ecommerce & Vendor Operations | Company Operations Manager | Ecommerce / Vendor Operations | ACTIVE | Shopify existing-shop/payment-readiness oversight + eBay P0 + vendor revenue lanes + Apparel/TikTok Affiliate; no paid ads | 2026-09-12 |
| Shopify Store Operations Worker | Company Operations / Ecommerce & Vendor Operations | Peter Torres | Shopify Store Operations / Direct Commerce | **ACTIVE — P0** | `SHOPIFY_STORE_OPERATIONS_CURRENT_WORKTREE.md` + `SHOPIFY_EXISTING_SHOP_TUNING_RETURN_2026-09-12.md`; **53 Online Store public / 50 VEVOR staging INTENTIONAL HOLD / DO NOT BULK PUBLISH**; latest verified Shopify Payments = `Complete setup`; tune existing public/installed surfaces → complete/reverify Payments → preserve PayPal → verify representative guest purchase path | 2026-09-12 |
...
| Apparel Vendor Operations Manager | Company Operations / Ecommerce & Vendor Operations / Apparel | Peter Torres | Apparel / POD Profitability | ACTIVE | `FOURTHWALL_EXISTING_SHOP_TUNING_RETURN_2026-09-12.md` + `APPAREL_VENDOR_OPERATIONS_CURRENT_WORKTREE.md`; **tune existing 29-product Fourthwall store first** → payout setup → promo/markdown safety → copy cleanup → 29-product economics → 3–5 hero set → exact TikTok sync only; Spreadconnect/Printify/Gelato/new-store/provider expansion **HOLD / BACKLOG** | 2026-09-12 |
| TikTok Affiliate Growth Manager | Company Operations / Ecommerce & Vendor Operations / TikTok Affiliate | Peter Torres | Affiliate / Creator Acquisition | **ACTIVE UNDER RESTRICTION** | `TIKTOK_EXISTING_SHOP_TUNING_RETURN_2026-09-12.md` + current affiliate Worktree; seller-verification/high-risk-shop appeal **FAILED / CANNOT APPEAL AGAIN**; no replay; fix exact OOS product, keep shop operationally clean, track held funds, control commission/samples, tune current catalog, wait for automatic re-evaluation or genuinely new platform remedy | 2026-09-12 |
...
| VEVOR Project Operations Manager | VEVOR Supplier / Catalog / Shopify / Fulfillment | Company Operations / MPM | Vendor Operations | ACTIVE | `VEVOR_CURRENT_WORKTREE.md`; 19 A-tier + 17/17 qualified B-tier ACTIVE; 3 promotion-cleared; 50-product Shopify staging cohort remains intentional hold unless exact release; first real order proof | 2026-09-12 |
...
A current Worktree marked CLOSED, EXECUTION CLOSED, SUBMITTED / WAITING, FAILED / CANNOT APPEAL AGAIN, or otherwise terminal defeats stale board/registry/chat pointers unless higher authority or a genuinely new external platform remedy explicitly reopens it.
