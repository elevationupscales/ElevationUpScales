...
| **P1** | Olight launch / catalog truth | Company Operations + Ecommerce & Vendor Operations / Peter | **ACTIVE — 10 LIVE / 3 DRAFT / PETER DRAFT-PRODUCTION AUTHORIZED** | Preserve the 10 live products. Peter's bounded queue is Odin S M-LOK → PL X GL → OSIGHT SE using Olight-authorized exact-product media; leave all three DRAFT for management review. No price, SKU, shipping, inventory-policy or publication/status changes under Peter's assignment. Baton 4 Black is live in Shopify but has a dated supplier-availability mismatch that remains a management reconciliation item. Use `vendor-project-sources/OLIGHT_PROJECT_SOURCE.md` + `OLIGHT_MASTER_CATALOG_TRUTH_2026-09-23.md`. |
...
| **P2** | Puerto Rico market entry — PR-01 / PR-02 | Company Operations + Shipping & Logistics + Ecommerce | **ACTIVE RESEARCH / QUALIFICATION — NO LAUNCH OR OUTREACH AUTHORITY** | Compare SOK SK12V100PC vs SK48V100N for 1/3-unit order-led pilot; qualify supplier authority/warranty, Crowley vs TOTE/consolidator freight, SURI/IVU/release responsibility, EEI procedure and landed economics. San Juan/Guaynabo terminal pickup first; delivery separate. Hawaii first shipment remains fulfillment priority. Peter remains on Olight; no PR reassignment. Use `PUERTO_RICO_MARKET_ENTRY_PR01_2026-09-24.md` + `PUERTO_RICO_PR02_QUALIFICATION_WORKTREE_2026-09-25.md`. |
...
- Real paid orders remain the highest-priority commerce event and supersede catalog polishing when they appear.
- Do not reopen payment-stack work absent a fresh customer-path defect.
...
# SUNGOLDPOWER CONTROL CHECKPOINT

SunGoldPower confirmed Elevation passed distributor review and may begin listing products on the company website. The supplier-issued 2026-09-15 price sheet provides exact SKU, MAP and stock state for the staged batch.

Batch 1 is recorded in `SUNGOLDPOWER_SHOPIFY_BATCH_1_2026-09-17.md` and consists of five Shopify DRAFT products:

- `SPH302460A` — 3000W 24V Solar Inverter Charger — $445 MAP;
- `SPH302480A` — 3000W 24V Solar Inverter Charger — $459 MAP;
- `SPH5048P` — 5000W 48V Solar Charger Inverter, 100A MPPT Parallel — $750 MAP;
- `SPH504880A` — 5000W 48V Solar Charger Inverter, 80A MPPT — $589 MAP;
- `SPH6548P` — 6500W 48V Split Phase Solar Charger Inverter — $1,150 MAP.

All five were supplier-listed in stock at the source-sheet checkpoint. They remain unpublished pending approved exact-SKU media, dropship/order-submission process, and Lower-48 shipping economics. Casey's Sept. 16 partner packet already requested those operating details; do not duplicate outreach without management approval.
