...
| **P1** | Olight launch / catalog truth | Company Operations + Ecommerce & Vendor Operations | **ACTIVE — 8 LIVE / 5 DRAFT / OCLIP CATALOG CORRECTED** | Oclip 2 Pro is cleanly limited to dealer-source-verified Black/Orange standard; Oclip 2 Ultra Premium is live separately at $94.99 with manufacturer media, Online Store publication and Olight shipping profile verified. Continue Sphere → Odin S M-LOK → PL X GL → OSIGHT SE; hold exact Baton 4 Black until source state changes. Use `vendor-project-sources/OLIGHT_PROJECT_SOURCE.md` + `OLIGHT_MASTER_CATALOG_TRUTH_2026-09-23.md`. |
