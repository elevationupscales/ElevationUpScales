...
| **P1** | Olight launch / catalog truth | Company Operations + Ecommerce & Vendor Operations | **ACTIVE — 7 LIVE / 5 DRAFT / PUBLIC-SAFE SOURCE ESTABLISHED** | Preserve the 7 verified live products; advance Sphere, Odin S M-LOK, PL X GL and OSIGHT SE only through exact source + media + purchaseability checks; hold exact Baton 4 Black until source state changes. Use `vendor-project-sources/OLIGHT_PROJECT_SOURCE.md` + `OLIGHT_MASTER_CATALOG_TRUTH_2026-09-23.md`. |
