...
| **P1** | Olight launch / catalog truth | Company Operations + Ecommerce & Vendor Operations | **ACTIVE — 9 LIVE / 4 DRAFT / SPHERE LIVE VERIFIED** | Oclip 2 Pro is cleanly limited to dealer-source-verified Black/Orange standard; Oclip 2 Ultra Premium is live separately at $94.99 with manufacturer media, Online Store publication and Olight shipping profile verified. Sphere is now live / verified with official Olight media and Shopify purchaseability confirmed. Continue Odin S M-LOK → PL X GL → OSIGHT SE; hold exact Baton 4 Black until source state changes. Use `vendor-project-sources/OLIGHT_PROJECT_SOURCE.md` + `OLIGHT_MASTER_CATALOG_TRUTH_2026-09-23.md`. |
