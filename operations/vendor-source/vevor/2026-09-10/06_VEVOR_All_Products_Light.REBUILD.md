...
The GitHub workflow `.github/workflows/vevor-bootstrap.yml` downloads the upstream workbook, selects those fields, writes `06_VEVOR_All_Products_Light.csv`, and rebuilds the public-safe VEVOR worker ZIP.
