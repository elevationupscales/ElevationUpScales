(() => {
  ...
  function installLogisticsCapability(){
    ...
    if(existing){
      track("homepage_logistics_capability_view","home",{sourceControl:"static-logistics"});
      return;
    }
    ...
    track("homepage_logistics_capability_view","home",{sourceControl:"dynamic-logistics"});
  }
