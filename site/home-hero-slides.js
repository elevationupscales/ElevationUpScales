  ...
  function enhanceUtilityAndHeader() {
    ...
    if (nav) {
      nav.innerHTML = `
        ...
        <details class="eus-menu reference-nav-menu"><summary class="eus-nav-trigger">Services <span class="eus-caret" aria-hidden="true"></span></summary><div class="eus-dropdown"><a href="/shipping-logistics-services"><span><strong>Shipping &amp; Logistics</strong><small>Service page</small></span></a><a href="/what-we-do#home-rv-services"><span><strong>Home &amp; RV Services</strong><small>Repair, restoration and upgrades</small></span></a><a href="/solar-services"><span><strong>Power &amp; Solar Services</strong><small>Planning and troubleshooting</small></span></a></div></details>
    ...
    hero.innerHTML = `
      ...
      <div class="container reference-storefront-hero__inner">
        ...
        <div class="reference-storefront-hero__visual" aria-label="SOK lithium battery systems">
          <div class="reference-sok-brand"><strong>SOK</strong><span>BATTERIES</span><small>BUILT FOR A STRONGER TOMORROW</small></div>
          <img class="reference-rack" src="/assets/brands/sok/sk48v100n/system-cabinet.png" alt="SOK 48V battery cabinet system" width="900" height="900">
          <a class="reference-product reference-product--12v" href="/sok/sk12v100pc/" aria-label="View SOK SK12V100PC"><img src="/assets/brands/sok/sk12v100pc/hero.png" alt="SOK SK12V100PC 12.8V 100Ah LiFePO4 battery" width="900" height="675"><span><b>SK12V100PC</b><small>12.8V 100Ah</small></span></a>
          <a class="reference-product reference-product--48v" href="/sok/sk48v100n/" aria-label="View SOK SK48V100N"><img src="/assets/brands/sok/sk48v100n/hero.jpg" alt="SOK SK48V100N 51.2V 100Ah rack battery" width="900" height="675"><span><b>SK48V100N</b><small>51.2V 100Ah</small></span></a>
    ...
    section.innerHTML = `
      <div class="container">
        ...
        <div class="reference-solutions__grid">
          <article class="reference-solution-card" style="--solution-image:url('/assets/brands/sok/sk12v100pc/hero.png')"><div><h3>Lithium Batteries</h3><p>Reliable power for any application.</p><a href="/lithium-batteries">Shop Batteries →</a></div></article>
          <article class="reference-solution-card" style="--solution-image:url('/assets/brands/sok/sk48v100n/system-cabinet.png')"><div><h3>SOK Battery Systems</h3><p>12V, 24V &amp; 48V systems.</p><a href="/sok-batteries">Shop SOK →</a></div></article>
          ...
          <article class="reference-solution-card" style="--solution-image:url('/assets/brands/sok/sk48v100n/hero.jpg')"><div><h3>Backup Power</h3><p>Keep what matters running.</p><a href="/sok-batteries">Shop Backup Power →</a></div></article>
          <article class="reference-solution-card" style="--solution-image:url('/assets/brands/sok/sk48v100n/system-cabinet.png')"><div><h3>Commercial Power</h3><p>Scalable power solutions.</p><a href="/sok-batteries">Shop Commercial →</a></div></article>
        </div>
      </div>`;
